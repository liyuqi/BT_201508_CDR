//mongo test --port 40000 "./kerry_gen.js" --eval "var src_col='src_col',dst_col='dst_col'" > ./test_result/kerry_gen$(date +"%Y%m%d")_$(date +"%H%M%S").txt
...
print('db.src_col.findOne:');
printjson(db.getCollection(src_col.toString()).findOne());