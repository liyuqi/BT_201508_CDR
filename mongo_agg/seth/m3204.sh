...
ssh btserver4@btserver4 "
mongo admin --port 20002 --eval \"config2 = {_id:'sh2',members:[{_id:0,host:'btserver2:20002'},{_id:1,host:'btserver4:20002',priority:2}]};rs.initiate(config2);\"
mongo admin --port 20003 --eval \"config3 = {_id:'sh3',members:[{_id:0,host:'btserver2:20003'},{_id:1,host:'btserver4:20003',priority:2}]};rs.initiate(config3);\"
"
...
mongo admin --port 40000 --eval 'sh.addShard("sh2/btserver2:20002,btserver4:20002")'
mongo admin --port 40000 --eval 'sh.addShard("sh3/btserver2:20003,btserver4:20003")'
